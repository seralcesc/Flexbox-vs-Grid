...
if (temaGuardado === "light") {
  ...
  checkboxInput.checked = false; // El interruptor va a la izquierda (Sol/Claro)
} else {
  // Por defecto (o si guardó dark), se queda en modo oscuro
  document.documentElement.removeAttribute("data-theme");
  checkboxInput.checked = true; // El interruptor va a la derecha (Luna/Oscuro)
}

// 2. Escuchamos cuando el interruptor cambia de posición (desliza)
